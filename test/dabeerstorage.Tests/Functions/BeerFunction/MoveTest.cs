...
namespace DaBeerStorage.Tests.Functions.BeerFunction
{
    public class MoveTest : BeerFunctionTest
    {
        ...
        [Fact]
        public void Should_Call_CheckRequest() => Call_CheckRequest<Move,MoveValidator>(moqFunction.Object.Create);

        [Theory,AutoData]
        public void Should_Return_Ok_When_Request_Is_Valid(Move objectTest)
        {
            Return_Ok_When_Request_Is_Valid<Move,MoveValidator>(mut.ListNotDrank,objectTest);
        }
        ...
        public void Should_Return_ErrorList_When_Object_Has_Invalid_Data(Move objectTest)
        {
            ...
            Return_BadRequest_WhenRequestIsValid<Move,MoveValidator>(mut.Create,objectTest);
        }
    }
}